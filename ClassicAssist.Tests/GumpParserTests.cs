...
namespace ClassicAssist.Tests
{
    ...
    public class GumpParserTests
    {
        ...
        {
            Cliloc.Initialize( () => new Dictionary<int, string> { { 1114513, "<DIV ALIGN=CENTER>~TEXT~</DIV>" } } );
        ...
        {
            Cliloc.Initialize( () => new Dictionary<int, string> { { 1114514, "<DIV ALIGN=RIGHT>CLOSE</DIV>" } } );
