...
namespace ClassicAssist.Data.Backup.OneDrive
{
    public class OneDriveConfigureViewModel : SetPropertyNotifyChanged
    {
        ...
        public ICommand LoginCommand => _loginCommand ?? ( _loginCommand = new RelayCommandAsync( Login, o => true ) );

        public ICommand LogoutCommand =>
            _logoutCommand ?? ( _logoutCommand = new RelayCommandAsync( Logout, o => true ) );
