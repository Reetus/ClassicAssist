...
{
    [FilterOptions( Name = " -  Bear Sounds", DefaultEnabled = true )]
    public class AudioFilterBearSounds : DynamicFilterEntry
    {
        private static readonly int[] _audioPackets = { 0xA3, 0xA5, 0xA6, }; // qk
