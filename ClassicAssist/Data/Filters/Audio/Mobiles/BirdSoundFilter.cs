...
{
    [FilterOptions( Name = " -  Bird Sounds", DefaultEnabled = true )]
    public class AudioFilterBirdSounds : DynamicFilterEntry
    {
        //private static readonly int[] _audioPackets = { 0x82A }; // 0x19
        private static readonly int[] _audioPackets = { 0x1C, 0x1B, 0x1E, 0x1D, 0x1F, 0x2EF }; // qk
