...
{
    [FilterOptions( Name = " -  Bull Sounds", DefaultEnabled = true )]
    public class AudioFilterBullSounds : DynamicFilterEntry
    {
        //private static readonly int[] _audioPackets = { 0x7B3 };
        private static readonly int[] _audioPackets = { 0x7B3 }; // not tested
