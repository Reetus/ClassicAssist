...
{
    [FilterOptions( Name = " -  Cat Sounds", DefaultEnabled = true )]
    public class AudioFilterCatSounds : DynamicFilterEntry
    {
        private static readonly int[] _audioPackets = { 0x69, 0x6D, 0x6A, 0x6C }; // qk
