...
{
    [FilterOptions( Name = " -  Deer Sounds", DefaultEnabled = true )]
    public class AudioFilterDeerSounds : DynamicFilterEntry
    {
        //private static readonly int[] _audioPackets = { 0x7A0, 0x82, 0x83 }; // 0x7A0 not sure
        private static readonly int[] _audioPackets = { 0x82, 0x83, 0x84 }; // qk
