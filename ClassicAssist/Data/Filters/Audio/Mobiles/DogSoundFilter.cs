...
{
    [FilterOptions( Name = " -  Dog Sounds", DefaultEnabled = true )]
    public class AudioFilterDogSounds : DynamicFilterEntry
    {
        private static readonly int[] _audioPackets = { 0x85, 0x86, 0x87, 0x88, 0x89 }; // qk
