...
{
    [FilterOptions( Name = " -  Eagle Sounds", DefaultEnabled = true )]
    public class AudioFilterEagleSounds : DynamicFilterEntry
    {
        private static readonly int[] _audioPackets = { 0x2F0, 0x2F1, 0x2EE, }; // qk
