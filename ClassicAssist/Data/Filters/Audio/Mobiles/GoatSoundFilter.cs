...
{
    [FilterOptions( Name = " -  Goat Sounds", DefaultEnabled = true )]
    public class AudioFilterGoatSounds : DynamicFilterEntry
    {
        private static readonly int[] _audioPackets = { 0x99, 0x9B, 0x9C, 0x9D }; // qk
