...
{
    [FilterOptions( Name = " -  Snake Sounds", DefaultEnabled = true )]
    public class AudioFilterSnakeSounds : DynamicFilterEntry
    {
        private static readonly int[] _audioPackets = { 0xDB }; // qk
