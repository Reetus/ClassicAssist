...
{
    [FilterOptions( Name = " -  Titan Cyclops Sounds", DefaultEnabled = true )]
    public class AudioFilterTitanCyclopsSounds : DynamicFilterEntry
    {
        //private static readonly int[] _audioPackets = { 0x7A7 };
        private static readonly int[] _audioPackets = { 0x7A7 }; // not checked
