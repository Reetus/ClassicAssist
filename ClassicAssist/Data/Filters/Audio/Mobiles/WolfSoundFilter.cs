...
{
    [FilterOptions( Name = " -  Wolf Sounds", DefaultEnabled = true )]
    public class AudioFilterWolfSounds : DynamicFilterEntry
    {
        private static readonly int[] _audioPackets = { 0xE5, 0xE6, 0xE7 }; // qk
