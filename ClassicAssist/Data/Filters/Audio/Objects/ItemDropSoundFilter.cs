...
{
    [FilterOptions( Name = " -  ItemDrop Sounds", DefaultEnabled = true )]
    public class AudioFilterItemDropSounds : DynamicFilterEntry
    {
        private static readonly int[] _audioPackets = { 0x48, 0x42 }; // qk
