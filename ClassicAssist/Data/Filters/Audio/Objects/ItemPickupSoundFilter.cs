...
{
    [FilterOptions( Name = " -  ItemPickup Sounds", DefaultEnabled = true )]
    public class AudioFilterItemPickupSounds : DynamicFilterEntry
    {
        private static readonly int[] _audioPackets = { 0x57 }; // qk
