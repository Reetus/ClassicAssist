...
{
    [FilterOptions( Name = " -  TeleportTile Sounds", DefaultEnabled = true )]
    public class AudioFilterTeleportTileSounds : DynamicFilterEntry
    {
        private static readonly int[] _audioPackets = { 0x1F0, 0x1FE }; // qk
