...
{
    [FilterOptions( Name = " -  Conquest Sounds", DefaultEnabled = true )]
    public class AudioFilterConquestSounds : DynamicFilterEntry
    {
        private static readonly int[] _audioPackets = { 0x208, 0x227, 0x2E7 }; // qk
