...
{
    [FilterOptions( Name = " -  Emote Sounds", DefaultEnabled = true )]
    public class AudioFilterEmoteSounds : DynamicFilterEntry
    {
                                                         
        private static readonly int[] _audioPackets = { 0x419, 0x41A, 0x41B, 0x41C, 0x41D, 0x420, 0x421, 0x422, // Human Male emotes only // TODO Add female emotes
                                                        ...
                                                        0x318, 0x36A, 0x447, 0x41E, 0x448, 0x449, 0x44A }; // qk 
