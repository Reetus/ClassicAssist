...
{
    [FilterOptions( Name = " -  FootStep Sounds", DefaultEnabled = true )]
    public class AudioFilterFootStepSounds : DynamicFilterEntry
    {
        private static readonly int[] _audioPackets = { 0x12B, 0x129 }; // grabbed from ClassicUO Mobile.cs // doesnt seem to be working -> client side ?
