...
{
    [FilterOptions( Name = " -  NpcVendor Sounds", DefaultEnabled = true )]
    public class AudioFilterNpcVendorSounds : DynamicFilterEntry
    {
        private static readonly int[] _audioPackets = { 0x32, 0x37 }; // qk
