...
{
    [FilterOptions( Name = " -  Weapon Sounds", DefaultEnabled = true )]
    public class AudioFilterWeaponSounds : DynamicFilterEntry
    {
        private static readonly int[] _audioPackets = { 0x23B, 0x23A }; // qk
