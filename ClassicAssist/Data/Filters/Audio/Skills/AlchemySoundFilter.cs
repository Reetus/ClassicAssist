...
{
    [FilterOptions( Name = " -  Alchemy Sounds", DefaultEnabled = true )]
    public class AudioFilterAlchemySounds : DynamicFilterEntry
    {
        private static readonly int[] _audioPackets = { 0x240 }; // qk
