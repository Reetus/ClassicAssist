...
{
    [FilterOptions( Name = " -  Blacksmith Sounds", DefaultEnabled = true )]
    public class AudioFilterBlacksmithSounds : DynamicFilterEntry
    {
        private static readonly int[] _audioPackets = { 0x0 }; // qk
