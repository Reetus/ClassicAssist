...
{
    [FilterOptions( Name = " -  Inscribing Sounds", DefaultEnabled = true )]
    public class AudioFilterInscribingSounds : DynamicFilterEntry
    {
        private static readonly int[] _audioPackets = { 0x249 }; // qk
