...
{
    [FilterOptions( Name = " -  Meditation Sounds", DefaultEnabled = true )]
    public class AudioFilterMeditationSounds : DynamicFilterEntry
    {
        private static readonly int[] _audioPackets = { 0xF9 }; // qk
