...
{
    [FilterOptions( Name = " -  SpiritSpeak Sounds", DefaultEnabled = true )]
    public class AudioFilterSpiritSpeakSounds : DynamicFilterEntry
    {
        //private static readonly int[] _audioPackets = { 0x24A };
        private static readonly int[] _audioPackets = { 0x24A }; // not checked
