...
{
    [FilterOptions( Name = " -  MoonGate Sounds", DefaultEnabled = true )]
    public class AudioFilterMoonGateSounds : DynamicFilterEntry
    {
        private static readonly int[] _audioPackets = { 0x20E, 0x1FE }; // qk
