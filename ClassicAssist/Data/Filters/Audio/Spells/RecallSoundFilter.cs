...
{
    [FilterOptions( Name = " -  Recall Sounds", DefaultEnabled = true )]
    public class AudioFilterRecallSounds : DynamicFilterEntry
    {
        private static readonly int[] _audioPackets = { 0x1FC }; // qk
