...
{
    [FilterOptions( Name = " -  SpellFizzle Sounds", DefaultEnabled = true )]
    public class AudioFilterSpellFizzleSounds : DynamicFilterEntry
    {
        //private static readonly int[] _audioPackets = { 0x5C }; 
        private static readonly int[] _audioPackets = { 0x5C }; // not checked
