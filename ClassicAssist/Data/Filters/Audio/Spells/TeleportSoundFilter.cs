...
{
    [FilterOptions( Name = " -  Teleport Sounds", DefaultEnabled = true )]
    public class AudioFilterTeleportSounds : DynamicFilterEntry
    {
        private static readonly int[] _audioPackets = { 0x1FE }; // qk
