...
{
    public class EnemiesTabViewModel : BaseViewModel, ISettingProvider
    {
        private ICommand _addFriendCommand;
        private ICommand _changeRehueOption;
        private ICommand _importCommand;
        private Options _options;
        private ICommand _removeEnemyCommand;
        ...
        public ICommand RemoveEnemyCommand =>
            _removeEnemyCommand ??
            ( _removeEnemyCommand = new RelayCommandAsync( RemoveEnemy, o => SelectedItem != null ) );
        ...
        private static async Task AddEnemy( object arg )
        {
            await Task.Run( () => MobileCommands.AddEnemy() );
        }
        private static Task RemoveEnemy( object arg )
        {
            if ( !( arg is EnemyEntry fe ) )
            {
                return Task.CompletedTask;
            }

            MobileCommands.RemoveEnemy( fe.Serial );
